...
here::i_am("introduccion_R/sesiones/03-Sintáxis/03 - Sintáxis - copia.Rmd")
```
...
## Formulas para limpiar el ambiente y establecer directorio de trabajo

```{r}
## Para limpiar el escritorio
"rm(ls=list())" 

#la funcion rm() es para remover objetos, y la sintáxis ls=list() hace referencia a todos los objetos en tu entorno de trabajar
...
# en el caso de realizar un trabajo compartido
...
![Operadores Lógicos](./../../public/img/03%20-%20Operadores%20Lógicos.png){width="80%"}
