...
db_cusco <- db_juntos |> filter(departamento == "CUSCO") #creemos una tabla solo con los datos de Cusco

db_aqp <- db_juntos |> filter(departamento == "AREQUIPA") #creemos otra tabla solo con los datos de Arequipa

no_abonados_cus <- db_cusco$hogares_afiliados - db_cusco$hogares_abonados #creamos un vector nuevo de los hogares no abonados en Cusco

no_abonados_aqp <- db_aqp$hogares_afiliados - db_aqp$hogares_abonados #creamos un vector nuevo de los hogares no abonados en Arequipa

length(no_abonados_cus) == count(db_cusco) # verifiquemos número de filas

length(no_abonados_aqp) == count(db_aqp) # verifiquemos número de filas
